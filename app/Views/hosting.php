    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        ...
        <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
            <div class="position-relative d-none d-lg-block h-100 width-left">
                <img class="position-absolute img-fluid centered" src="<?= base_url(); ?>/assets/images/hosting.jpg" alt="" />
            </div>
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    <div class="align-items-center justify-content-center d-lg-none d-flex">
                        ...
                        <img class="img-fluid" src="<?= base_url(); ?>/assets/images/hosting.jpg" alt="" />
                    </div>
                    ...
                    <form style="margin-top: 1.5rem" action="" method="post">
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="" id="password-content-4-1" placeholder="Your Password" minlength="6" required />
